...
blog.name = "GIS programmer writing Python in Emacs"

## blog_description -- A short one line description of the blog
# used in the RSS/Atom feeds.
blog.description = "(loop [code '()] (if (perfect? code) code (recur (conj code bug))))"
